...
/dev/null talks es una comunidad adherida a [SVQtech](https://svqtech.com/). Por tanto, al unirte a nuestra comunidad se entiende que has leído, comprendes y aceptas el espíritu del [manifiesto de SVQtech](https://svqtech.com/manifiesto/).

Sin perjuicio de lo anterior, nos hacemos eco del [Berlín Code Of Conduct](https://berlincodeofconduct.org/es/), un código de conducta para todas las comunidades de usuarios y conferencias.
...
Si Ud. es víctima o testigo de comportamiento inaceptable, o tiene cualquier otra preocupación o problema, por favor notifíquelo a un organizador de la comunidad tan pronto como sea posible. Puede hacerlo directamente durante la realización del evento o contactar con el equipo de organización en la dirección de correo electrónico [devnulltalks@gmail.com](mailto:devnulltalks@gmail.com).
